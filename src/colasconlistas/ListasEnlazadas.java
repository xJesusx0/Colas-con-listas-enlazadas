...
import static colasconlistas.Main.*;
import static colasconlistas.Metodos.*;
import static colasconlistas.Nodo.*;
import static colasconlistas.Estilos.*;
...
public class ListasEnlazadas {
    ...
    public static void iniciarLista(){
        ...
        if(existeLista()){
            mostrarError("La cola ya ha sido creada");
            return;
        } 
        ...
        avisoFin("cola creada correctamente");
    }
    ...
    public static void imprimirLista(){
        ...
        if(!existeLista()){
            mostrarError("La cola no existe");
            return;
        }
